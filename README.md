...
//WORKING
| POST   | /api/posts              | Creates a post using the information sent inside the `request body`.                                                                                 //notworking               |
| POST   | /api/posts/:id/comments | Creates a comment for the post with the specified id using information sent inside of the `request body`.                                                  
//WORKING                 |
| GET    | /api/posts              | Returns an array of all the post objects contained in the database.                                                                                       //WORKING        |
| GET    | /api/posts/:id          | Returns the post object with the specified id.                                                                                                          //WORKING        |
| GET    | /api/posts/:id/comments | Returns an array of all the comment objects associated with the post with the specified id.                                                            // not working             |
